...
import FixedScheduleExtendInImmunizationUnit from "@/components/fixedSchedules/FixedScheduleExtendInImmunizationUnit.vue";
...
<template>
  <BasePageHeading
    title="LỊCH LÀM VIỆC (TCMR)"
    subtitle="Quản lý / tra cứu lịch tiêm thuộc chường trình tiêm chủng mở rộng (TCMR) tại cơ sở"
  >
    <template #extra>
  ...
  <div class="content">
            ...
            >
              ...
              <td
                v-if="
                  ...
                  fixedSchedule.vaccinationType == 'MO_RONG'
                "
              >
                <Toggle
    ...
    <template v-if="authStore.immunizationUnitId != 'null'">
      <FixedScheduleExtendInImmunizationUnit
